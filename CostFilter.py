...
parser.add_argument('--right_image', '-r', type=str, required=True, help='right image path')
parser.add_argument('--disparity_image', '-o', default = './disparity.png', type=str, help='disparity image path')
